...
//? в инпуты из формочки для редактирования добавить соответсвующие значения. id, imageURL
//? добавить событие на кнопку из формочки для редактирования, которая будет сохранять изменения
//? как эти изменения сохранить? перебрать массив в котором хранятся все элементы с помощью метода массива МАР и если найдем совпадение, то заменить этот обьект на измененный и вызвать э функцию для отображения
